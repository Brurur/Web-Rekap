...
function showkelas() {
  ...
  if (kelas == "XII AK 1") {
    ...
    var newOptions2 = [
      ...
      'ALMA YESA OKTAVIANA',
      'BELLA FEBRYA ZETA',
      'CHAIRUNISA FEBRIANA PUTRI',
      'CHIKAL SALEHAH HANAN',
      'DEWI PUSTIKA SARI',
      'ELSA NURPADIA',
      'FAISAL ARIE ARDIYANSYAH',
      'GADIZH MEYANDRI',
      'INTAN DWI CAHYANI',
      'ISTIQOMAH DWI WULANDARI',
      'LIVIA KHAIRUNISSA',
      'MARCELLINA VICTORIA',
      'MARSHA SAFALINA',
      'NAURA AYU IRAWAN PUTRI',
      'NESYA NURSYABILLA',
      'NOVIANTI PUTRI',
      'NUR ZIKRIYAH',
      'NURUL KHOIRIAH',
      ...
      'RIRI DWI ARIYANI',
      'RISKA',
      'SABILA ALYAN FATIMAH',
      'SHIFA NAJMAH KHAIRUNNISA',
      'SHOFIYAH WARDAH AFIFAH',
      'SITI NUR LAELA',
      'SITI TSUROYA AKMAL',
      'SYAFA NANDILHAMSYAH',
      'WARDATUT TOYYIBAH',
      'ZAZQIA AZ-ZAHRA RAMADHANI GUCI'
  ];
